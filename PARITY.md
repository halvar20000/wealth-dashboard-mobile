...
| 16 | German, French, Spanish | 🚧 partial | 🚧 German | the dashboard has all three; iOS: German in one String Catalog (`ios/Shared/Localizable.xcstrings`, shared by app, widget and share sheet) plus `InfoPlist.xcstrings` per target |
