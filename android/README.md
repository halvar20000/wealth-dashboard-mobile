# Wealth Dashboard — the Android app

Part of [wealth-dashboard-mobile](../README.md); the contract both
clients keep is [CONTRACT.md](../CONTRACT.md), and who has what is
[PARITY.md](../PARITY.md).
...
**Where it is:** everything on the parity table except the watch. On
Google Play as an internal test since 1.0.0.
...
```bash
cd android
gradle :app:assembleDebug        # android/app/build/outputs/apk/debug/
